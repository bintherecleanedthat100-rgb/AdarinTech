  ...
  const cols = [
    {
      head: 'Solutions',
      links: [
        { l: 'Business Websites', h: '#services' },
        { l: 'Web Applications', h: '#services' },
        { l: 'Full Stack Dev', h: '#services' },
        { l: 'Pricing', h: '#pricing' },
      ],
    },
    {
      head: 'Company',
      links: [
        { l: 'About Layne', h: '#about' },
        { l: 'How It Works', h: '#process' },
        { l: 'FAQ', h: '#faq' },
        { l: 'Book a Free Call', h: '#contact' },
      ],
    },
    {
      head: 'Industries',
      links: [
        { l: 'HVAC & Heating', h: '#contact' },
        { l: 'Plumbing', h: '#contact' },
        { l: 'Landscaping', h: '#contact' },
        { l: 'Construction', h: '#contact' },
      ],
    },
  ]
          ...
          {cols.map(col => (
            <div key={col.head}>
              ...
              <ul className="space-y-3">
                {col.links.map(({ l, h }) => (
                  <li key={l}>
                    <a href={h} className="font-sans text-sm text-snow/50 hover:text-cyan transition-colors">{l}</a>
                  </li>
                ))}
              </ul>
            </div>
